...
" Custom color scheme based on Nord
...
let s:p.normal.left = [ [ s:nord1, s:nord9 ], [ s:nord5, s:nord1 ] ]
...
let g:lightline#colorscheme#nord_minimal#palette = lightline#colorscheme#flatten(s:p)
